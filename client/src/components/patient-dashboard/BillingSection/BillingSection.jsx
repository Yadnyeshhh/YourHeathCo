...
import LucideIcon from "../LucideIcon/LucideIcon"; // Import the new LucideIcon component
import "../../../styles/patient-dashboard/billingsection.css";
  ...
  return <div className="billing-section">
      ...
      <div className="billing-average-section">
        ...
        <div className="billing-average-chart">
          {[100, 200, 150, 250, 180].map((amount, index) => <div key={index} className="billing-average-item">
